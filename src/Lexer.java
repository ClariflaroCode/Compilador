...
public class Lexer {
    ...
    public static Map<String, Integer> filaSimbolos;
    ...
    public void construyeAccionesSemanticas(){
    	//por ahora faltan todos los warnings
                ...
                AccionSemantica as15=(lexema,entrada)->{
                    ...
                    if (entrada=='\n'){
                        line++;
                        System.out.println("Warning: Cadena terminada con salto de linea en linea "+line);
                    }
					if (tablaSimbolos.containsKey(lexema)) {
                    	tablaSimbolos.put(lexema,tokenOutput);
                    }
                ...
                AccionSemantica as22=(lexema,entrada)->{
                    lexema=lexema+"$";
                    System.out.println("Warning: falta $ en constante entera en linea "+line);
                ...
                AccionSemantica as24=(lexema,entrada)->{
                    System.out.println("Warning: falta parte decimal en constante flotante en linea "+line);
                    lexema=lexema+"0";
